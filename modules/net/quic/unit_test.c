...
static void quic_pnspace_test2(struct kunit *test)
{
	...
	msleep(50);
	space->time = jiffies_to_usecs(jiffies);
	/* ! max_pn_time - last_max_pn_time < max_time_limit */
	KUNIT_EXPECT_EQ(test, 0, quic_pnspace_mark(space, 4));
	KUNIT_EXPECT_EQ(test, 1, space->base_pn);
	KUNIT_EXPECT_EQ(test, 0, quic_pnspace_mark(space, 1));
	KUNIT_EXPECT_EQ(test, 0, quic_pnspace_mark(space, 6));
...
static u8 secret[48] = {
	0x55, 0xe7, 0x18, 0x93, 0x73, 0x08, 0x09, 0xf6, 0xbf, 0xa1, 0xab, 0x66,
	0xe8, 0xfc, 0x02, 0xde, 0x17, 0xfa, 0xbe, 0xc5, 0x4a, 0xe7, 0xe4, 0xb8,
	0x25, 0x48, 0xff, 0xe9, 0xd6, 0x7d, 0x8e, 0x0e};

static u8 data[296] = {
	};

static u8 encrypted_data[296] = {
	};
...
static void quic_crypto_test1(struct kunit *test)
{
	...
	ret = quic_crypto_initial_keys_install(&crypto, &conn_id,
					       QUIC_VERSION_V1, 0);
	KUNIT_EXPECT_EQ(test, ret, 0);
	...
	KUNIT_EXPECT_EQ(test, ret, 0);
	KUNIT_EXPECT_EQ(test, tokenlen, 1 + sizeof(addr) + 8 + conn_id.len +
			      QUIC_TAG_LEN);

	ret = quic_crypto_verify_token(&crypto, &addr, sizeof(addr), &tmpid,
				       token, tokenlen);
	KUNIT_EXPECT_EQ(test, ret, 0);
	...
	ret = quic_crypto_get_retry_tag(&crypto, skb, &conn_id, QUIC_VERSION_V1,
					token);
	KUNIT_EXPECT_EQ(test, ret, 0);
	kfree_skb(skb);
out:
...
static void quic_crypto_test2(struct kunit *test)
{
	...
	err = __sock_create(&init_net, PF_INET, SOCK_DGRAM, IPPROTO_QUIC, &sock,
			    1);
	if (err)
		return;
...
static void quic_cong_test2(struct kunit *test)
{
	...
	/* recovery -> cong_avoid: after SACK if recovery_time < time */
	msleep(20);
	cong.time = jiffies_to_usecs(jiffies);
	time = cong.time;
	bytes = 1400;
	...
	/* slow_start -> cong_avoid: after SACK if cwnd > ssthresh */
	time = cong.time - 300000;
	bytes = 10532;
	quic_cong_on_packet_acked(&cong, time, bytes, 0);
	KUNIT_EXPECT_EQ(test, cong.state, QUIC_CONG_CONGESTION_AVOIDANCE);
